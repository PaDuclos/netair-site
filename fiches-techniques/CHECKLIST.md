...
- [ ] **Humidité 100 % (sans condensation)** ajoutée le 04/08 — **non sourcée** chez Titanair (Camfil dit 100 %, AFPRO 90 %), comme sur toute la gamme. ⚠️ **Correction du 04/08** : il a été écrit (message de commit `f882116` et première rédaction de cette fiche) que LAM était « la dernière des 18 fiches » sans ligne humidité. **C'est faux** — contrôle programmatique sur les 18 JSON : **NETCEL V NIVAL et NETCARB BAG n'en ont toujours pas**. À traiter à leur passe respective.
